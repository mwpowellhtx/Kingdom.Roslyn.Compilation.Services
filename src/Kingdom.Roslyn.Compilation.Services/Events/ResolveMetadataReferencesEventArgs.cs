...
namespace Kingdom.Roslyn.Compilation
{
    ...
    /// <summary>
    /// Use the <see cref="ResolveMetadataReferencesEventArgs"/> members in order to specify
    /// the requisite <see cref="MetadataReference"/> instances.
    /// </summary>
    /// <inheritdoc cref="ICanReferenceAssembly{T}"/>
    public class ResolveMetadataReferencesEventArgs : EventArgs, ICanReferenceAssembly<ResolveMetadataReferencesEventArgs>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the Project involved in the <see cref="MetadataReference"/> Resolution. The
        /// instance is furnished strictly for informational purposes only and because a
