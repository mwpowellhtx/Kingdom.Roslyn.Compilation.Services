...
{
    /// <summary>
    /// Provides helpful Asset extension methods.
    /// </summary>
    public static class AssetExtensionMethods
    {
        ...
        /// <returns></returns>
        public static T MergeAssets<T, TBits>(this T obj, TBits bits, MergeAssetsCallback<T, TBits> merge, Predicate<TBits> predicate = null)
